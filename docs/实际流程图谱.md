...
本文依据当前本地 `mskatoni-patch-beta` 工作树中的代码绘制，用来回答“系统现在实际上怎样运行”。对应目标见 [设计流程图谱.md](设计流程图谱.md)。当前 Git HEAD 仍为 `6e177b9`，下述 `v1.3.6` 修改尚未提交。
...
| 版本发布状态 | 本地代码升至 1.3.6，但不提交和发布 | tracked 文件为 1.3.6，Git HEAD 和 tag 仍为 1.3.5；忽略的 lockfile 仅本地更新 | 符合本地修改约束 |
